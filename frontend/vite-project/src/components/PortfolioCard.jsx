...
export default function PortfolioCard({ stock }) {
  ...
  // 2. Dynamic Period Label based on Dashboard Toggle
  ...
  return (
    <Card 
      onClick={() => navigate(`/stock/${stock.symbol.toUpperCase()}`)} // ✅ Trigger deep-dive
      sx={{ 
        minWidth: 280, 
        borderRadius: 6, 
        ...
        '&:hover': { 
            ...
            borderColor: '#6366f1' // ✅ Visual feedback on hover
        }
      }}
    >
      <CardContent sx={{ p: 3 }}>
